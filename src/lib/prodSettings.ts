...
export const PROD_PROVIDERS: ProdProviderDefinition[] = [
  ...
  },
  {
    ...
    installCommand: "brew tap render-oss/render && brew install render",
  ...
  },
  {
    ...
    installCommand: "brew tap heroku/brew && brew install heroku",
...
function normalizeProdProviderDefinition(input: unknown): ProdProviderDefinition | null {
  ...
  return {
    ...
    installCommand:
      nullableString(input.installCommand ?? input.install_command) ?? fallback?.installCommand ?? null,
    loginCommand:
