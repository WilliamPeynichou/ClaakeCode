...
const APP_REFERER: &str = "https://github.com/WilliamPeynichou/Wilide";
const APP_TITLE: &str = "wilide";
...
mod tests {
    use serde_json::json;
    use wilide_core::{ChatMessage, ModelCapabilities, ModelRef, ProviderRequest};
