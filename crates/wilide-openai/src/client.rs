...
const FALLBACK_INSTRUCTIONS: &str = "You are wilide, a concise coding assistant.";
...
mod tests {
    use serde_json::json;
    use wilide_core::{ChatMessage, ModelRef, Part, ProviderRequest, Role, ToolResultImage};
