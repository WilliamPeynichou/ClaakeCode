...
use claakecode_app::{
    ...
    list_workspace_files,     normalize_workspace_root, probe_caveman, probe_mcp_servers, read_external_file,
    ...
    CavemanActivationInput, CavemanAvailability, CavemanSettings,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            conversations::list_caveman_settings,
            conversations::save_caveman_settings,
            conversations::probe_caveman_settings,
